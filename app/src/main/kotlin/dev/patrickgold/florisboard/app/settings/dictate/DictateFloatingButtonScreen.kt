        ...
        if (enabled && serviceEnabled) {
            ...
            ListPreference(
                ...
                entries = listPrefEntries {
                    ...
                    entry(
                        DictateFloatingButtonDesign.PUDIM,
                        stringRes(R.string.dictate__floating_button_design_pudim),
                        stringRes(R.string.dictate__floating_button_design_pudim_summary),
                    )
                },
            )
